...
analysis_data$trait_SAP = ( analysis_data$final_area_cm2 * 100 ) / analysis_data$final_blade_perimeter_cm
...
pca_data_as_no=na.omit(pca_data %>% filter(binomial_code=="as_no") %>% select(-trait_SBA))
