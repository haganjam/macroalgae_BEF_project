...
gam.alg = mgcv::gam(growth_area_cm2_percent ~ s(depth_treatment)+s(Species),data=analysis_data)
plot(gam.alg)
...
pca_data
pca_data=analysis_data %>% select(Species,depth_treatment,site_code,tile_id,growth_area_cm2_percent,contains("trait"))
